...
namespace eval ::optrace {
  variable script "/home/wangjiakun/Development/emperor_soc/hardware/emperor.runs/top_mmio_subsystem_0_2_synth_1/top_mmio_subsystem_0_2.tcl"
...
set cacheID [config_ip_cache -export -no_bom  -dir /home/wangjiakun/Development/emperor_soc/hardware/emperor.runs/top_mmio_subsystem_0_2_synth_1 -new_name top_mmio_subsystem_0_2 -ip [get_ips top_mmio_subsystem_0_2]]
...
synth_design -top top_mmio_subsystem_0_2 -part xc7a200tfbg676-2 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix top_mmio_subsystem_0_2_ top_mmio_subsystem_0_2.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_mmio_subsystem_0_2_stub.v
 lappend ipCachedFiles top_mmio_subsystem_0_2_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_mmio_subsystem_0_2_stub.vhdl
 lappend ipCachedFiles top_mmio_subsystem_0_2_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_mmio_subsystem_0_2_sim_netlist.v
 lappend ipCachedFiles top_mmio_subsystem_0_2_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_mmio_subsystem_0_2_sim_netlist.vhdl
 lappend ipCachedFiles top_mmio_subsystem_0_2_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp top_mmio_subsystem_0_2.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips top_mmio_subsystem_0_2]
 }
...
rename_ref -prefix_all top_mmio_subsystem_0_2_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef top_mmio_subsystem_0_2.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file top_mmio_subsystem_0_2_utilization_synth.rpt -pb top_mmio_subsystem_0_2_utilization_synth.pb"  } 
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force /home/wangjiakun/Development/emperor_soc/hardware/emperor.runs/top_mmio_subsystem_0_2_synth_1/top_mmio_subsystem_0_2.dcp /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /home/wangjiakun/Development/emperor_soc/hardware/emperor.runs/top_mmio_subsystem_0_2_synth_1/top_mmio_subsystem_0_2_stub.v /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/wangjiakun/Development/emperor_soc/hardware/emperor.runs/top_mmio_subsystem_0_2_synth_1/top_mmio_subsystem_0_2_stub.vhdl /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/wangjiakun/Development/emperor_soc/hardware/emperor.runs/top_mmio_subsystem_0_2_synth_1/top_mmio_subsystem_0_2_sim_netlist.v /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/wangjiakun/Development/emperor_soc/hardware/emperor.runs/top_mmio_subsystem_0_2_synth_1/top_mmio_subsystem_0_2_sim_netlist.vhdl /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /home/wangjiakun/Development/emperor_soc/hardware/emperor.ip_user_files/ip/top_mmio_subsystem_0_2]} {
  catch { 
    file copy -force /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_stub.v /home/wangjiakun/Development/emperor_soc/hardware/emperor.ip_user_files/ip/top_mmio_subsystem_0_2
  }
}

if {[file isdir /home/wangjiakun/Development/emperor_soc/hardware/emperor.ip_user_files/ip/top_mmio_subsystem_0_2]} {
  catch { 
    file copy -force /home/wangjiakun/Development/emperor_soc/hardware/emperor.gen/sources_1/bd/top/ip/top_mmio_subsystem_0_2/top_mmio_subsystem_0_2_stub.vhdl /home/wangjiakun/Development/emperor_soc/hardware/emperor.ip_user_files/ip/top_mmio_subsystem_0_2
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "top_mmio_subsystem_0_2_synth_1" END { }
