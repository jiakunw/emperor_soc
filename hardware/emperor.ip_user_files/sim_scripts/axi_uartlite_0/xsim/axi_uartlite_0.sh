...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_4 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_uartlite_v2_0_37 -L secureip -L xpm --snapshot axi_uartlite_0 xil_defaultlib.axi_uartlite_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_uartlite_0 -key {Behavioral:sim_1:Functional:axi_uartlite_0} -tclbatch cmd.tcl -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_uartlite_0.wdb xsim.dir libdpi.so)
