...
design_libs=(axi_lite_ipif_v3_0_4 lib_pkg_v1_0_4 lib_srl_fifo_v1_0_4 lib_cdc_v1_0_3 axi_uartlite_v2_0_37 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_uartlite_0 -o axi_uartlite_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_uartlite_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_uartlite_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_uartlite_0_simv.daidir vcs_lib c.obj)
