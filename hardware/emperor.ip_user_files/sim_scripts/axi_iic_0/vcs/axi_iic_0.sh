...
design_libs=(lib_pkg_v1_0_4 lib_cdc_v1_0_3 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_iic_v2_1_9 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work axi_iic_v2_1_9 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_iic_0 -o axi_iic_0_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_iic_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_iic_0_simv.daidir vcs_lib c.obj)
