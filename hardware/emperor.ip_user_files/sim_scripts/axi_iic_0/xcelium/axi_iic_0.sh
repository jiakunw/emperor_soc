...
#
# Script generated by Vivado on Thu Sep 18 22:45:48 CST 2025
...
#
# Usage        : axi_iic_0.sh
#                axi_iic_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_iic_0.sh [-reset_run]
#                axi_iic_0.sh [-reset_log]
#                axi_iic_0.sh [-help]
#
...
#                script (type 'axi_iic_0.sh -help' for more information).
#
...
design_libs_elab="-libname lib_pkg_v1_0_4 -libname lib_cdc_v1_0_3 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_5 -libname axi_iic_v2_1_9 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver lib_pkg_v1_0_4 lib_cdc_v1_0_3 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_iic_v2_1_9 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_iic_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_iic_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work axi_iic_v2_1_9 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_iic_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_iic_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_iic_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: axi_iic_0.sh [-step]\n\
Usage: axi_iic_0.sh [-lib_map_path]\n\
Usage: axi_iic_0.sh [-reset_run]\n\
Usage: axi_iic_0.sh [-reset_log]\n\
Usage: axi_iic_0.sh [-keep_index]\n\
