...
design_libs=(xpm microblaze_v11_0_14 microblaze_riscv_v1_0_3 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.microblaze_riscv_0 xil_defaultlib.glbl -o microblaze_riscv_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./microblaze_riscv_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key microblaze_riscv_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc microblaze_riscv_0_simv.daidir vcs_lib c.obj)
