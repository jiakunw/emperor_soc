...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L microblaze_v11_0_14 -L microblaze_riscv_v1_0_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot microblaze_riscv_0 xil_defaultlib.microblaze_riscv_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim microblaze_riscv_0 -key {Behavioral:sim_1:Functional:microblaze_riscv_0} -tclbatch cmd.tcl -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb microblaze_riscv_0.wdb xsim.dir libdpi.so)
