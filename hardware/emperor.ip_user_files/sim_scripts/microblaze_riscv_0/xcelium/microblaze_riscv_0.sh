...
#
# Script generated by Vivado on Sun Aug 31 05:30:43 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : microblaze_riscv_0.sh
...
#
# Usage        : microblaze_riscv_0.sh
#                microblaze_riscv_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                microblaze_riscv_0.sh [-reset_run]
#                microblaze_riscv_0.sh [-reset_log]
#                microblaze_riscv_0.sh [-help]
#
...
#                script (type 'microblaze_riscv_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname microblaze_v11_0_14 -libname microblaze_riscv_v1_0_3 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm microblaze_v11_0_14 microblaze_riscv_v1_0_3 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "microblaze_riscv_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./microblaze_riscv_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.microblaze_riscv_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.microblaze_riscv_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log microblaze_riscv_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./microblaze_riscv_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: microblaze_riscv_0.sh [-help]\n\
Usage: microblaze_riscv_0.sh [-step]\n\
Usage: microblaze_riscv_0.sh [-lib_map_path]\n\
Usage: microblaze_riscv_0.sh [-reset_run]\n\
Usage: microblaze_riscv_0.sh [-reset_log]\n\
Usage: microblaze_riscv_0.sh [-keep_index]\n\
Usage: microblaze_riscv_0.sh [-noclean_files]\n\n\
