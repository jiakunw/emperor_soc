...
module axi_mmio_controller
    ...
    output logic debug_state_transition,
    output logic [15:0] debug_front_addr
    );
    ...
    assign debug_state_transition = S_AXI_awvalid && (S_AXI_awaddr[31:16] == 16'h4600);
    assign debug_front_addr = S_AXI_awaddr[31:16];
